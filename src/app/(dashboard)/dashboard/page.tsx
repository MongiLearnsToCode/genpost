        ...
        <div className=\"bg-white rounded-lg shadow p-6\">
          ...
          <div className=\"space-y-4\">
            <div className=\"p-4 bg-blue-50 rounded-lg\">
              <h3 className=\"text-lg font-semibold text-blue-900\">Welcome to GenPost!</h3>
              <p className=\"text-blue-800 mt-2\">
                Your social media management dashboard is being built. Soon you'll be able to:
              </p>
              <ul className=\"list-disc list-inside mt-2 text-blue-800 space-y-1\">
                <li>Create and schedule posts across Instagram, Twitter, and Facebook</li>
